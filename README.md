...
* [ThreeDotsLabs/watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 9,887 | 🐛 81 | 🌐 Go | 📅 2026-08-25 - Go library for building event-driven applications with Pub/Sub, CQRS, and middleware support.
...
* [ddd-crew/ddd-starter-modelling-process](https://github.com/ddd-crew/ddd-starter-modelling-process) ⭐ 6,019 | 🐛 13 | 📅 2026-08-23 - Step-by-step DDD modelling process guide from discovery to bounded context design.
...
* [iluwatar/java-design-patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 94,684 | 🐛 130 | 🌐 Java | 📅 2026-08-31 - Collection of GoF, enterprise, and architectural patterns implemented in Java.
* [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) ⭐ 48,848 | 🐛 16 | 📅 2024-12-02 - Guide explaining design patterns with real-world analogies, not academic jargon.
* [faif/python-patterns](https://github.com/faif/python-patterns) ⭐ 42,977 | 🐛 15 | 🌐 Python | 📅 2026-09-10 - Collection of design patterns and idioms implemented in Python with concise examples.
* [DesignPatternsPHP](https://github.com/DesignPatternsPHP/DesignPatternsPHP) ⭐ 22,189 | 🐛 1 | 🌐 PHP | 📅 2025-02-03 - All known design patterns in PHP 8.1+ with real-world examples, UML diagrams, and tests.
...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines) ⭐ 23,331 | 🐛 178 | 📅 2026-08-05 - Microsoft's battle-tested guidelines for consistent, developer-friendly RESTful APIs.
...
* [Flutter Design Docs](https://github.com/flutter/flutter/wiki/Design-Documents) ⭐ 178,892 | 🐛 13,147 | 🌐 Dart | 📅 2026-09-11 - Flutter's public design document process for major architectural decisions.
* [Next.js RFCs](https://github.com/vercel/next.js/discussions/categories/rfc) ⭐ 142,234 | 🐛 3,340 | 🌐 JavaScript | 📅 2026-09-11 - Vercel's public RFC discussions for Next.js architectural changes and new features.
* [joelparkerhenderson/architecture-decision-record](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,887 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - Collection of ADR templates, examples, and best practices from real projects.
* [Rust RFCs](https://github.com/rust-lang/rfcs) ⭐ 6,594 | 🐛 795 | 🌐 Markdown | 📅 2026-09-10 - Rust language design decisions captured as RFCs — one of the best public RFC processes.
...
* [Kubernetes KEPs](https://github.com/kubernetes/enhancements/tree/master/keps) ⭐ 3,943 | 🐛 440 | 🌐 Go | 📅 2026-09-10 - Real-world architecture decision process at scale — Kubernetes Enhancement Proposals.
* [adr/madr](https://github.com/adr/madr) ⭐ 2,474 | 🐛 28 | 🌐 Markdown | 📅 2026-08-28 - Markdown Any Decision Records — lean template capturing context, decision, and consequences.
* [log4brains](https://github.com/thomvaill/log4brains) ⭐ 1,584 | 🐛 57 | 🌐 TypeScript | 📅 2024-12-17 - Docs-as-code knowledge base that auto-generates a searchable static site from ADR files.
...
* [Mermaid](https://github.com/mermaid-js/mermaid) ⭐ 90,200 | 🐛 1,783 | 🌐 TypeScript | 📅 2026-09-10 - JavaScript diagramming tool rendering flowcharts, sequence diagrams from Markdown syntax.
* [Diagrams as Code](https://github.com/mingrammer/diagrams) ⭐ 42,611 | 🐛 390 | 🌐 Python | 📅 2026-09-10 - Draw AWS, Azure, GCP, and Kubernetes architecture diagrams in Python with provider icons.
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,163 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-09 - Validate and visualize JavaScript/TypeScript module dependencies against architecture rules.
...
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,163 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-09 - JavaScript/TypeScript module dependency validation against configurable architecture rules.
* [TNG/ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,828 | 🐛 172 | 🌐 Java | 📅 2026-09-11 - Industry-standard Java library for checking architecture constraints as unit tests.
* [tach-org/tach](https://github.com/tach-org/tach) ⭐ 2,814 | 🐛 47 | 🌐 Rust | 📅 2026-09-08 - Rust-powered Python tool for enforcing module boundaries and dependencies with zero runtime cost.
...
* [LemonAppDev/konsist](https://github.com/LemonAppDev/konsist) ⭐ 1,722 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-11 - Kotlin architecture linter enforcing coding conventions, project structure, and dependency rules.
* [TNG/ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,359 | 🐛 35 | 🌐 C# | 📅 2026-09-11 - C# port of ArchUnit for enforcing architecture rules in .NET projects.
...
* [LukasNiessen/ArchUnitTS](https://github.com/LukasNiessen/ArchUnitTS) ⭐ 478 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-10 - TypeScript port of ArchUnit for enforcing architecture rules with CI integration.
