...
* [ThreeDotsLabs/watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 9,873 | 🐛 80 | 🌐 Go | 📅 2026-08-25 - Go library for building event-driven applications with Pub/Sub, CQRS, and middleware support.
* [ThreeDotsLabs/wild-workouts-go-ddd-example](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,436 | 🐛 30 | 🌐 Go | 📅 2026-08-27 - Production-ready Go example combining Clean Architecture, CQRS, and gRPC with detailed blog series.
* [ddd-crew/ddd-starter-modelling-process](https://github.com/ddd-crew/ddd-starter-modelling-process) ⭐ 6,005 | 🐛 13 | 📅 2026-08-23 - Step-by-step DDD modelling process guide from discovery to bounded context design.
...
* [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ⭐ 215 | 🐛 19 | 🌐 PHP | 📅 2026-08-31 - Modern PHP Event Sourcing library with snapshots, projections, and Doctrine integration.
...
* [iluwatar/java-design-patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 94,638 | 🐛 117 | 🌐 Java | 📅 2026-08-30 - Collection of GoF, enterprise, and architectural patterns implemented in Java.
* [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) ⭐ 48,831 | 🐛 16 | 📅 2024-12-02 - Guide explaining design patterns with real-world analogies, not academic jargon.
* [faif/python-patterns](https://github.com/faif/python-patterns) ⭐ 42,954 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - Collection of design patterns and idioms implemented in Python with concise examples.
...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines) ⭐ 23,336 | 🐛 176 | 📅 2026-08-05 - Microsoft's battle-tested guidelines for consistent, developer-friendly RESTful APIs.
...
* [Flutter Design Docs](https://github.com/flutter/flutter/wiki/Design-Documents) ⭐ 178,733 | 🐛 13,214 | 🌐 Dart | 📅 2026-08-31 - Flutter's public design document process for major architectural decisions.
* [Next.js RFCs](https://github.com/vercel/next.js/discussions/categories/rfc) ⭐ 142,039 | 🐛 3,580 | 🌐 JavaScript | 📅 2026-08-31 - Vercel's public RFC discussions for Next.js architectural changes and new features.
* [joelparkerhenderson/architecture-decision-record](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,782 | 🐛 10 | 📅 2026-08-20 - Collection of ADR templates, examples, and best practices from real projects.
* [Rust RFCs](https://github.com/rust-lang/rfcs) ⭐ 6,592 | 🐛 799 | 🌐 Markdown | 📅 2026-08-15 - Rust language design decisions captured as RFCs — one of the best public RFC processes.
* [GitHub Actions Toolkit ADRs](https://github.com/actions/toolkit/tree/main/docs/adrs) ⭐ 5,837 | 🐛 585 | 🌐 TypeScript | 📅 2026-08-05 - Architecture Decision Records from GitHub's official Actions toolkit.
* [Kubernetes KEPs](https://github.com/kubernetes/enhancements/tree/master/keps) ⭐ 3,935 | 🐛 418 | 🌐 Go | 📅 2026-08-31 - Real-world architecture decision process at scale — Kubernetes Enhancement Proposals.
* [adr/madr](https://github.com/adr/madr) ⭐ 2,438 | 🐛 28 | 🌐 Markdown | 📅 2026-08-28 - Markdown Any Decision Records — lean template capturing context, decision, and consequences.
...
* [Mermaid](https://github.com/mermaid-js/mermaid) ⭐ 90,015 | 🐛 1,764 | 🌐 TypeScript | 📅 2026-08-31 - JavaScript diagramming tool rendering flowcharts, sequence diagrams from Markdown syntax.
* [Diagrams as Code](https://github.com/mingrammer/diagrams) ⭐ 42,571 | 🐛 388 | 🌐 Python | 📅 2026-08-16 - Draw AWS, Azure, GCP, and Kubernetes architecture diagrams in Python with provider icons.
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,119 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-29 - Validate and visualize JavaScript/TypeScript module dependencies against architecture rules.
...
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,119 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-29 - JavaScript/TypeScript module dependency validation against configurable architecture rules.
* [TNG/ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,819 | 🐛 167 | 🌐 Java | 📅 2026-08-31 - Industry-standard Java library for checking architecture constraints as unit tests.
* [tach-org/tach](https://github.com/tach-org/tach) ⭐ 2,803 | 🐛 57 | 🌐 Rust | 📅 2026-08-27 - Rust-powered Python tool for enforcing module boundaries and dependencies with zero runtime cost.
...
* [LemonAppDev/konsist](https://github.com/LemonAppDev/konsist) ⭐ 1,717 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-27 - Kotlin architecture linter enforcing coding conventions, project structure, and dependency rules.
* [TNG/ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,354 | 🐛 31 | 🌐 C# | 📅 2026-08-31 - C# port of ArchUnit for enforcing architecture rules in .NET projects.
...
* [phparkitect/arkitect](https://github.com/phparkitect/arkitect) ⭐ 927 | 🐛 38 | 🌐 PHP | 📅 2026-08-30 - Define PHP architecture rules with expressive DSL — enforce layer dependencies in CI.
* [LukasNiessen/ArchUnitTS](https://github.com/LukasNiessen/ArchUnitTS) ⭐ 472 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-25 - TypeScript port of ArchUnit for enforcing architecture rules with CI integration.
