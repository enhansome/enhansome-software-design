...
* [ddd-crew/ddd-starter-modelling-process](https://github.com/ddd-crew/ddd-starter-modelling-process) ⭐ 6,037 | 🐛 13 | 📅 2026-08-23 - Step-by-step DDD modelling process guide from discovery to bounded context design.
...
* [iluwatar/java-design-patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 94,731 | 🐛 128 | 🌐 Java | 📅 2026-09-13 - Collection of GoF, enterprise, and architectural patterns implemented in Java.
* [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) ⭐ 48,881 | 🐛 18 | 📅 2024-12-02 - Guide explaining design patterns with real-world analogies, not academic jargon.
* [faif/python-patterns](https://github.com/faif/python-patterns) ⭐ 43,015 | 🐛 12 | 🌐 Python | 📅 2026-09-24 - Collection of design patterns and idioms implemented in Python with concise examples.
...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines) ⭐ 23,336 | 🐛 180 | 📅 2026-08-05 - Microsoft's battle-tested guidelines for consistent, developer-friendly RESTful APIs.
...
* [Flutter Design Docs](https://github.com/flutter/flutter/wiki/Design-Documents) ⭐ 179,100 | 🐛 13,273 | 🌐 Dart | 📅 2026-09-26 - Flutter's public design document process for major architectural decisions.
* [Next.js RFCs](https://github.com/vercel/next.js/discussions/categories/rfc) ⭐ 142,469 | 🐛 3,493 | 🌐 JavaScript | 📅 2026-09-26 - Vercel's public RFC discussions for Next.js architectural changes and new features.
* [joelparkerhenderson/architecture-decision-record](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 17,026 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-25 - Collection of ADR templates, examples, and best practices from real projects.
* [Rust RFCs](https://github.com/rust-lang/rfcs) ⭐ 6,603 | 🐛 793 | 🌐 Markdown | 📅 2026-09-10 - Rust language design decisions captured as RFCs — one of the best public RFC processes.
* [GitHub Actions Toolkit ADRs](https://github.com/actions/toolkit/tree/main/docs/adrs) ⭐ 5,858 | 🐛 591 | 🌐 TypeScript | 📅 2026-09-25 - Architecture Decision Records from GitHub's official Actions toolkit.
* [Kubernetes KEPs](https://github.com/kubernetes/enhancements/tree/master/keps) ⭐ 3,958 | 🐛 469 | 🌐 Go | 📅 2026-09-26 - Real-world architecture decision process at scale — Kubernetes Enhancement Proposals.
* [adr/madr](https://github.com/adr/madr) ⭐ 2,518 | 🐛 29 | 🌐 Markdown | 📅 2026-08-28 - Markdown Any Decision Records — lean template capturing context, decision, and consequences.
* [log4brains](https://github.com/thomvaill/log4brains) ⭐ 1,597 | 🐛 57 | 🌐 TypeScript | 📅 2024-12-17 - Docs-as-code knowledge base that auto-generates a searchable static site from ADR files.
...
* [Mermaid](https://github.com/mermaid-js/mermaid) ⭐ 90,430 | 🐛 1,827 | 🌐 TypeScript | 📅 2026-09-21 - JavaScript diagramming tool rendering flowcharts, sequence diagrams from Markdown syntax.
...
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,221 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-23 - Validate and visualize JavaScript/TypeScript module dependencies against architecture rules.
...
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,221 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-23 - JavaScript/TypeScript module dependency validation against configurable architecture rules.
* [TNG/ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,843 | 🐛 173 | 🌐 Java | 📅 2026-09-26 - Industry-standard Java library for checking architecture constraints as unit tests.
...
* [LemonAppDev/konsist](https://github.com/LemonAppDev/konsist) ⭐ 1,728 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-25 - Kotlin architecture linter enforcing coding conventions, project structure, and dependency rules.
* [TNG/ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,368 | 🐛 36 | 🌐 C# | 📅 2026-09-25 - C# port of ArchUnit for enforcing architecture rules in .NET projects.
...
* [LukasNiessen/ArchUnitTS](https://github.com/LukasNiessen/ArchUnitTS) ⭐ 492 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-22 - TypeScript port of ArchUnit for enforcing architecture rules with CI integration.
* [arch-go/arch-go](https://github.com/arch-go/arch-go) ⭐ 274 | 🐛 25 | 🌐 Go | 📅 2026-09-24 - Architecture testing for Go with configurable rule sets for dependencies, naming, and layering constraints.
