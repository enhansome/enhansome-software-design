...
* [ThreeDotsLabs/wild-workouts-go-ddd-example](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,409 | 🐛 30 | 🌐 Go | 📅 2025-11-03 - Production-ready Go example combining Clean Architecture, CQRS, and gRPC with detailed blog series.
* [ddd-crew/ddd-starter-modelling-process](https://github.com/ddd-crew/ddd-starter-modelling-process) ⭐ 5,974 | 🐛 13 | 📅 2026-08-01 - Step-by-step DDD modelling process guide from discovery to bounded context design.
...
* [iluwatar/java-design-patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 94,595 | 🐛 157 | 🌐 Java | 📅 2026-07-31 - Collection of GoF, enterprise, and architectural patterns implemented in Java.
...
* [Flutter Design Docs](https://github.com/flutter/flutter/wiki/Design-Documents) ⭐ 178,400 | 🐛 13,132 | 🌐 Dart | 📅 2026-08-14 - Flutter's public design document process for major architectural decisions.
* [Next.js RFCs](https://github.com/vercel/next.js/discussions/categories/rfc) ⭐ 141,784 | 🐛 4,268 | 🌐 JavaScript | 📅 2026-08-14 - Vercel's public RFC discussions for Next.js architectural changes and new features.
* [joelparkerhenderson/architecture-decision-record](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,650 | 🐛 10 | 📅 2026-08-12 - Collection of ADR templates, examples, and best practices from real projects.
...
* [adr/madr](https://github.com/adr/madr) ⭐ 2,395 | 🐛 32 | 🌐 Markdown | 📅 2026-08-03 - Markdown Any Decision Records — lean template capturing context, decision, and consequences.
...
* [Mermaid](https://github.com/mermaid-js/mermaid) ⭐ 89,755 | 🐛 1,699 | 🌐 TypeScript | 📅 2026-08-14 - JavaScript diagramming tool rendering flowcharts, sequence diagrams from Markdown syntax.
* [Diagrams as Code](https://github.com/mingrammer/diagrams) ⭐ 42,507 | 🐛 385 | 🌐 Python | 📅 2026-08-14 - Draw AWS, Azure, GCP, and Kubernetes architecture diagrams in Python with provider icons.
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,060 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-10 - Validate and visualize JavaScript/TypeScript module dependencies against architecture rules.
...
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,060 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-10 - JavaScript/TypeScript module dependency validation against configurable architecture rules.
* [TNG/ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,798 | 🐛 174 | 🌐 Java | 📅 2026-08-12 - Industry-standard Java library for checking architecture constraints as unit tests.
...
* [TNG/ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,346 | 🐛 37 | 🌐 C# | 📅 2026-08-14 - C# port of ArchUnit for enforcing architecture rules in .NET projects.
