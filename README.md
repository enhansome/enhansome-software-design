...
* [ThreeDotsLabs/watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 9,890 | 🐛 81 | 🌐 Go | 📅 2026-08-25 - Go library for building event-driven applications with Pub/Sub, CQRS, and middleware support.
* [ThreeDotsLabs/wild-workouts-go-ddd-example](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,454 | 🐛 30 | 🌐 Go | 📅 2026-08-27 - Production-ready Go example combining Clean Architecture, CQRS, and gRPC with detailed blog series.
* [ddd-crew/ddd-starter-modelling-process](https://github.com/ddd-crew/ddd-starter-modelling-process) ⭐ 6,020 | 🐛 13 | 📅 2026-08-23 - Step-by-step DDD modelling process guide from discovery to bounded context design.
...
* [iluwatar/java-design-patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 94,686 | 🐛 128 | 🌐 Java | 📅 2026-09-13 - Collection of GoF, enterprise, and architectural patterns implemented in Java.
* [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) ⭐ 48,847 | 🐛 16 | 📅 2024-12-02 - Guide explaining design patterns with real-world analogies, not academic jargon.
* [faif/python-patterns](https://github.com/faif/python-patterns) ⭐ 42,981 | 🐛 12 | 🌐 Python | 📅 2026-09-12 - Collection of design patterns and idioms implemented in Python with concise examples.
...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines) ⭐ 23,330 | 🐛 179 | 📅 2026-08-05 - Microsoft's battle-tested guidelines for consistent, developer-friendly RESTful APIs.
...
* [Flutter Design Docs](https://github.com/flutter/flutter/wiki/Design-Documents) ⭐ 178,940 | 🐛 13,164 | 🌐 Dart | 📅 2026-09-14 - Flutter's public design document process for major architectural decisions.
* [Next.js RFCs](https://github.com/vercel/next.js/discussions/categories/rfc) ⭐ 142,283 | 🐛 3,368 | 🌐 JavaScript | 📅 2026-09-14 - Vercel's public RFC discussions for Next.js architectural changes and new features.
* [joelparkerhenderson/architecture-decision-record](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,913 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - Collection of ADR templates, examples, and best practices from real projects.
* [Rust RFCs](https://github.com/rust-lang/rfcs) ⭐ 6,596 | 🐛 794 | 🌐 Markdown | 📅 2026-09-10 - Rust language design decisions captured as RFCs — one of the best public RFC processes.
* [GitHub Actions Toolkit ADRs](https://github.com/actions/toolkit/tree/main/docs/adrs) ⭐ 5,848 | 🐛 590 | 🌐 TypeScript | 📅 2026-09-09 - Architecture Decision Records from GitHub's official Actions toolkit.
* [Kubernetes KEPs](https://github.com/kubernetes/enhancements/tree/master/keps) ⭐ 3,950 | 🐛 447 | 🌐 Go | 📅 2026-09-14 - Real-world architecture decision process at scale — Kubernetes Enhancement Proposals.
* [adr/madr](https://github.com/adr/madr) ⭐ 2,484 | 🐛 28 | 🌐 Markdown | 📅 2026-08-28 - Markdown Any Decision Records — lean template capturing context, decision, and consequences.
* [log4brains](https://github.com/thomvaill/log4brains) ⭐ 1,588 | 🐛 57 | 🌐 TypeScript | 📅 2024-12-17 - Docs-as-code knowledge base that auto-generates a searchable static site from ADR files.
...
* [Mermaid](https://github.com/mermaid-js/mermaid) ⭐ 90,242 | 🐛 1,786 | 🌐 TypeScript | 📅 2026-09-14 - JavaScript diagramming tool rendering flowcharts, sequence diagrams from Markdown syntax.
* [Diagrams as Code](https://github.com/mingrammer/diagrams) ⭐ 42,612 | 🐛 390 | 🌐 Python | 📅 2026-09-10 - Draw AWS, Azure, GCP, and Kubernetes architecture diagrams in Python with provider icons.
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,173 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-13 - Validate and visualize JavaScript/TypeScript module dependencies against architecture rules.
...
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,173 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-13 - JavaScript/TypeScript module dependency validation against configurable architecture rules.
* [TNG/ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,830 | 🐛 172 | 🌐 Java | 📅 2026-09-14 - Industry-standard Java library for checking architecture constraints as unit tests.
* [tach-org/tach](https://github.com/tach-org/tach) ⭐ 2,816 | 🐛 46 | 🌐 Rust | 📅 2026-09-14 - Rust-powered Python tool for enforcing module boundaries and dependencies with zero runtime cost.
...
* [TNG/ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,360 | 🐛 36 | 🌐 C# | 📅 2026-09-14 - C# port of ArchUnit for enforcing architecture rules in .NET projects.
...
* [LukasNiessen/ArchUnitTS](https://github.com/LukasNiessen/ArchUnitTS) ⭐ 480 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-13 - TypeScript port of ArchUnit for enforcing architecture rules with CI integration.
