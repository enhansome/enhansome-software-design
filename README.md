...
* [ThreeDotsLabs/watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 9,896 | 🐛 81 | 🌐 Go | 📅 2026-08-25 - Go library for building event-driven applications with Pub/Sub, CQRS, and middleware support.
* [ThreeDotsLabs/wild-workouts-go-ddd-example](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,458 | 🐛 30 | 🌐 Go | 📅 2026-08-27 - Production-ready Go example combining Clean Architecture, CQRS, and gRPC with detailed blog series.
* [ddd-crew/ddd-starter-modelling-process](https://github.com/ddd-crew/ddd-starter-modelling-process) ⭐ 6,029 | 🐛 13 | 📅 2026-08-23 - Step-by-step DDD modelling process guide from discovery to bounded context design.
...
* [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ⭐ 217 | 🐛 23 | 🌐 PHP | 📅 2026-09-16 - Modern PHP Event Sourcing library with snapshots, projections, and Doctrine integration.
...
* [iluwatar/java-design-patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 94,706 | 🐛 128 | 🌐 Java | 📅 2026-09-13 - Collection of GoF, enterprise, and architectural patterns implemented in Java.
* [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) ⭐ 48,862 | 🐛 16 | 📅 2024-12-02 - Guide explaining design patterns with real-world analogies, not academic jargon.
* [faif/python-patterns](https://github.com/faif/python-patterns) ⭐ 42,992 | 🐛 14 | 🌐 Python | 📅 2026-09-17 - Collection of design patterns and idioms implemented in Python with concise examples.
* [DesignPatternsPHP](https://github.com/DesignPatternsPHP/DesignPatternsPHP) ⭐ 22,191 | 🐛 1 | 🌐 PHP | 📅 2025-02-03 - All known design patterns in PHP 8.1+ with real-world examples, UML diagrams, and tests.
...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines) ⭐ 23,334 | 🐛 179 | 📅 2026-08-05 - Microsoft's battle-tested guidelines for consistent, developer-friendly RESTful APIs.
...
* [Flutter Design Docs](https://github.com/flutter/flutter/wiki/Design-Documents) ⭐ 178,987 | 🐛 13,188 | 🌐 Dart | 📅 2026-09-17 - Flutter's public design document process for major architectural decisions.
* [Next.js RFCs](https://github.com/vercel/next.js/discussions/categories/rfc) ⭐ 142,347 | 🐛 3,407 | 🌐 JavaScript | 📅 2026-09-17 - Vercel's public RFC discussions for Next.js architectural changes and new features.
* [joelparkerhenderson/architecture-decision-record](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,943 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-17 - Collection of ADR templates, examples, and best practices from real projects.
* [Rust RFCs](https://github.com/rust-lang/rfcs) ⭐ 6,598 | 🐛 793 | 🌐 Markdown | 📅 2026-09-10 - Rust language design decisions captured as RFCs — one of the best public RFC processes.
* [GitHub Actions Toolkit ADRs](https://github.com/actions/toolkit/tree/main/docs/adrs) ⭐ 5,853 | 🐛 589 | 🌐 TypeScript | 📅 2026-09-09 - Architecture Decision Records from GitHub's official Actions toolkit.
* [Kubernetes KEPs](https://github.com/kubernetes/enhancements/tree/master/keps) ⭐ 3,951 | 🐛 465 | 🌐 Go | 📅 2026-09-17 - Real-world architecture decision process at scale — Kubernetes Enhancement Proposals.
* [adr/madr](https://github.com/adr/madr) ⭐ 2,490 | 🐛 28 | 🌐 Markdown | 📅 2026-08-28 - Markdown Any Decision Records — lean template capturing context, decision, and consequences.
* [log4brains](https://github.com/thomvaill/log4brains) ⭐ 1,591 | 🐛 57 | 🌐 TypeScript | 📅 2024-12-17 - Docs-as-code knowledge base that auto-generates a searchable static site from ADR files.
...
* [GOV.UK RFCs](https://github.com/alphagov/govuk-rfcs) ⭐ 79 | 🐛 5 | 📅 2026-09-16 - UK Government Digital Service architecture decisions — excellent public sector ADR example.
...
* [Mermaid](https://github.com/mermaid-js/mermaid) ⭐ 90,285 | 🐛 1,787 | 🌐 TypeScript | 📅 2026-09-15 - JavaScript diagramming tool rendering flowcharts, sequence diagrams from Markdown syntax.
* [Diagrams as Code](https://github.com/mingrammer/diagrams) ⭐ 42,622 | 🐛 390 | 🌐 Python | 📅 2026-09-10 - Draw AWS, Azure, GCP, and Kubernetes architecture diagrams in Python with provider icons.
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,188 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-16 - Validate and visualize JavaScript/TypeScript module dependencies against architecture rules.
...
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,188 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-16 - JavaScript/TypeScript module dependency validation against configurable architecture rules.
* [TNG/ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,835 | 🐛 172 | 🌐 Java | 📅 2026-09-16 - Industry-standard Java library for checking architecture constraints as unit tests.
* [tach-org/tach](https://github.com/tach-org/tach) ⭐ 2,820 | 🐛 47 | 🌐 Rust | 📅 2026-09-15 - Rust-powered Python tool for enforcing module boundaries and dependencies with zero runtime cost.
...
* [LemonAppDev/konsist](https://github.com/LemonAppDev/konsist) ⭐ 1,724 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-11 - Kotlin architecture linter enforcing coding conventions, project structure, and dependency rules.
* [TNG/ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,363 | 🐛 36 | 🌐 C# | 📅 2026-09-17 - C# port of ArchUnit for enforcing architecture rules in .NET projects.
* [roblaszczak/go-cleanarch](https://github.com/roblaszczak/go-cleanarch) ⭐ 983 | 🐛 5 | 🌐 Go | 📅 2021-11-08 - Go validator enforcing Clean Architecture dependency rules across packages.
* [phparkitect/arkitect](https://github.com/phparkitect/arkitect) ⭐ 930 | 🐛 38 | 🌐 PHP | 📅 2026-09-15 - Define PHP architecture rules with expressive DSL — enforce layer dependencies in CI.
* [LukasNiessen/ArchUnitTS](https://github.com/LukasNiessen/ArchUnitTS) ⭐ 483 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-15 - TypeScript port of ArchUnit for enforcing architecture rules with CI integration.
