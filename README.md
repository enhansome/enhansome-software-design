...
* [ThreeDotsLabs/watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 9,898 | 🐛 82 | 🌐 Go | 📅 2026-08-25 - Go library for building event-driven applications with Pub/Sub, CQRS, and middleware support.
...
* [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) ⭐ 48,875 | 🐛 18 | 📅 2024-12-02 - Guide explaining design patterns with real-world analogies, not academic jargon.
* [faif/python-patterns](https://github.com/faif/python-patterns) ⭐ 42,993 | 🐛 13 | 🌐 Python | 📅 2026-09-18 - Collection of design patterns and idioms implemented in Python with concise examples.
...
* [Flutter Design Docs](https://github.com/flutter/flutter/wiki/Design-Documents) ⭐ 179,018 | 🐛 13,247 | 🌐 Dart | 📅 2026-09-20 - Flutter's public design document process for major architectural decisions.
* [Next.js RFCs](https://github.com/vercel/next.js/discussions/categories/rfc) ⭐ 142,391 | 🐛 3,461 | 🌐 JavaScript | 📅 2026-09-20 - Vercel's public RFC discussions for Next.js architectural changes and new features.
* [joelparkerhenderson/architecture-decision-record](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,977 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-18 - Collection of ADR templates, examples, and best practices from real projects.
* [Rust RFCs](https://github.com/rust-lang/rfcs) ⭐ 6,599 | 🐛 793 | 🌐 Markdown | 📅 2026-09-10 - Rust language design decisions captured as RFCs — one of the best public RFC processes.
...
* [Kubernetes KEPs](https://github.com/kubernetes/enhancements/tree/master/keps) ⭐ 3,956 | 🐛 476 | 🌐 Go | 📅 2026-09-19 - Real-world architecture decision process at scale — Kubernetes Enhancement Proposals.
* [adr/madr](https://github.com/adr/madr) ⭐ 2,497 | 🐛 28 | 🌐 Markdown | 📅 2026-08-28 - Markdown Any Decision Records — lean template capturing context, decision, and consequences.
...
* [Mermaid](https://github.com/mermaid-js/mermaid) ⭐ 90,315 | 🐛 1,792 | 🌐 TypeScript | 📅 2026-09-18 - JavaScript diagramming tool rendering flowcharts, sequence diagrams from Markdown syntax.
* [Diagrams as Code](https://github.com/mingrammer/diagrams) ⭐ 42,628 | 🐛 390 | 🌐 Python | 📅 2026-09-10 - Draw AWS, Azure, GCP, and Kubernetes architecture diagrams in Python with provider icons.
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,201 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-20 - Validate and visualize JavaScript/TypeScript module dependencies against architecture rules.
...
* [dependency-cruiser](https://github.com/sverweij/dependency-cruiser) ⭐ 7,201 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-20 - JavaScript/TypeScript module dependency validation against configurable architecture rules.
...
* [TNG/ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,364 | 🐛 35 | 🌐 C# | 📅 2026-09-18 - C# port of ArchUnit for enforcing architecture rules in .NET projects.
...
* [phparkitect/arkitect](https://github.com/phparkitect/arkitect) ⭐ 932 | 🐛 39 | 🌐 PHP | 📅 2026-09-19 - Define PHP architecture rules with expressive DSL — enforce layer dependencies in CI.
* [LukasNiessen/ArchUnitTS](https://github.com/LukasNiessen/ArchUnitTS) ⭐ 488 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-15 - TypeScript port of ArchUnit for enforcing architecture rules with CI integration.
